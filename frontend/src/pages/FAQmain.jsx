...
const FAQmain = () => {
    ...
    return (
        ...
        <div className="container-fluid mt-5" id='FAQmain'>

            <div className="row bg-dark text-white py-5">
                <div className="col-12 mt-5 text-center" >
                    <h2 className='mt-5'>How Can We Help?</h2>
                    <span>GET ANSWERS TO FREQUENTLY ASKED QUESTIONS</span> <br />
                    <input type='text' placeholder='search' className='rounded-pill  mx-auto w-50'></input>
                </div>
            </div>
